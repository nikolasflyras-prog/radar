...
DEFAULTS: dict[str, Any] = {
    ...
    "domain_whois": {"recent_registration_days": 90, "recent_change_days": 90},
    "rss_feeds": [],
    "conferences": [],
    "known_people": [],
...
def load_config(path: Path | None) -> dict[str, Any]:
    ...
    cfg["tokens"]["uspto"] = os.getenv("USPTO_API_KEY", cfg["tokens"].get("uspto"))
    cfg["tokens"]["openalex"] = os.getenv("OPENALEX_API_KEY", cfg["tokens"].get("openalex"))
